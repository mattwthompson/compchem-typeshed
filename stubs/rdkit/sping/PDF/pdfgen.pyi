...
class Canvas:
    ...
    def save(self, filename: Any | None = ..., fileobj: Any | None = ...) -> None: ...
    ...
    def drawInlineImage(self, image, x, y, width: Any | None = ..., height: Any | None = ...) -> None: ...
    def readJPEGInfo(self, image): ...
    def setPageCompression(self, onoff: int = ...) -> None: ...
    def setPageTransition(self, effectname: Any | None = ..., duration: int = ..., direction: int = ..., dimension: str = ..., motion: str = ...) -> None: ...
