...
def fontHeight(canvas, font: Any | None = ...): ...
def fontAscent(canvas, font: Any | None = ...): ...
def fontDescent(canvas, font: Any | None = ...): ...
def stringWidth(canvas, s, font: Any | None = ...): ...
def rotateXY(x, y, theta): ...
def drawString(canvas, s, x, y, font: Any | None = ..., color: Any | None = ..., angle: int = ...) -> None: ...
def test1() -> None: ...
def test2() -> None: ...
def allTagCombos(canvas, x, y, font: Any | None = ..., color: Any | None = ..., angle: int = ...): ...
