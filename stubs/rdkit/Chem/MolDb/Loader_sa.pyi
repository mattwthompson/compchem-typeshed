...
def LoadDb(suppl, dbName, nameProp: str = ..., nameCol: str = ..., silent: bool = ..., redraw: bool = ..., errorsTo: Any | None = ..., keepHs: bool = ..., defaultVal: str = ..., skipProps: bool = ..., regName: str = ..., skipSmiles: bool = ..., maxRowsCached: int = ..., uniqNames: bool = ..., addComputedProps: bool = ..., lazySupplier: bool = ..., numForPropScan: int = ..., startAnew: bool = ...) -> None: ...
