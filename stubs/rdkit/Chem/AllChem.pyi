...
def GetConformerRMS(mol, confId1, confId2, atomIds: Any | None = ..., prealigned: bool = ...): ...
def GetConformerRMSMatrix(mol, atomIds: Any | None = ..., prealigned: bool = ...): ...
def EnumerateLibraryFromReaction(reaction, sidechainSets, returnReactants: bool = ...) -> Generator[Any, None, None]: ...
